  ...
  create or replace   view sthibeault_test_db.dbt_sthibeault.int_shipment_touchpoints
...
transcripts as (
    ...
    join sthibeault_test_db.dbt_sthibeault.stg_crm_notes n on n.note_id = t.crm_note_id
