...
create or replace transient table sthibeault_test_db.dbt_sthibeault.fct_incidents
    
    
    
    as (-- Incident fact (grain: one row per incident), enriched with hub city and flags
