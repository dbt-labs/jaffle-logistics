...
create or replace transient table sthibeault_test_db.dbt_sthibeault.fct_account_health
    
    
    
    as (-- Monthly account-health fact (grain: one row per client-month). Surfaces the
