...
create or replace transient table sthibeault_test_db.dbt_sthibeault.split_context_docs
    
    
    
    as (-- Layer-1 splitter (deterministic, zero AI cost): turn each document body into one
