...
create or replace transient table sthibeault_test_db.dbt_sthibeault.chunk_docs
    
    
    
    as (-- Pack document sentences into token-bounded chunks (package chunk(), zero AI cost).
